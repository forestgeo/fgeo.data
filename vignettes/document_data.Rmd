...
For example, if your data comes from Barro Colorado Island, and it is a ViewFullTable containing a random subset of a few trees, a good name for it would be `luquillo_vft_random`. This format works well with auto-completion in RStudio.

...
This article sets conventions to document datasets in the __fgeo.opendata__ package. This makes it easier to understand the existing datasets and provides some structure to facilitate the expansion of __fgeo.opendata__.
...
* Definition of each column in the `generic_dataset`:
    ...
    * Option 2: Define each column in the help file of `generic_description` (e.g. `?`[census_description](https://forestgeo.github.io/fgeo.opendata/reference/census_description.html)).

* The help file of `generic_description` should include the following (e.g. `?`[vft_description](https://forestgeo.github.io/fgeo.opendata/reference/vft_description.html)):
...
* `info` should be a single short string indicating the most prominent characteristic of the specific dataset -- commonly referring to the criteria used to subset a larger dataset (e.g. `stem6_random_bci`).
...
The documentation of `site_generic_info` should include the following (e.g. `?`[bci_vft_random](https://forestgeo.github.io/fgeo.opendata/reference/vft_bci.html)):

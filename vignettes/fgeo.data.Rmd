...
Some datasets combine multiple censuses in a sigle dataframe.
...
If you don't have habitat data, you can create it by creating some categories of similar elevation.

```{r}
hab <- luquillo_elevation$col %>%
...
# You may rename the levels
levels(hab$habitats) <- letters[1:5]
